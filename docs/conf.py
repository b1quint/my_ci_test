...
htmlhelp_basename = 'TestingRTDdoc'
...
latex_documents = [
    (master_doc, 'TestingRTD.tex', 'Testing RTD Documentation',
     'Bruno Quint', 'manual'),
]
...
man_pages = [
    (master_doc, 'testingrtd', 'Testing RTD Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TestingRTD', 'Testing RTD Documentation',
     author, 'TestingRTD', 'One line description of project.',
     'Miscellaneous'),
]
